// 注: process.env.XX 是 Vercel 的環境變量，配置方式見：https://docs.tangly1024.com/zh/features/personality
const BLOG = {
  AUTHOR: 'james yang', // 作者
  BIO: '我的網路筆記本', // 作者简介
  LINK: 'https://james.logtw.com/', // 网站地址
  KEYWORDS: 'Notion, 前端開發, 美安, 電子商務', // 網站關鍵詞 英文逗號隔開
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '9dde71c8e69e498eb105109dc6c30c52', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  NOTION_ACCESS_TOKEN: process.env.NOTION_ACCESS_TOKEN || '', // Useful if you prefer not to make your database public
  DEBUG: process.env.NEXT_PUBLIC_DEBUG || false, // 是否顯示測試按鈕
  ...
  CONTACT_EMAIL: 'james.logtw@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
